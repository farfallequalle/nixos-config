# Generated by Powerlevel10k configuration wizard on 2026-02-03 at 00:48 CET.
...
() {
  ...
  # Custom Nix icon segment
  typeset -g POWERLEVEL9K_CUSTOM_NIX_ICON="echo 󱄅"
  typeset -g POWERLEVEL9K_CUSTOM_NIX_ICON_FOREGROUND=$cyan

  # Left prompt segments.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    custom_nix_icon           # Nix logo
    # context                 # user@host
  ...
  # Enable all git hooks for full status
  ...
  # Show commit counts for ahead/behind
